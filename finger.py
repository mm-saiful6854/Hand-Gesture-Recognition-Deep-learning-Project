# -*- coding: utf-8 -*-
"""
Created on Sat Dec 21 11:50:52 2019
...
def hist_masking(frame, hist):
    ...
    ret, thresh = cv2.threshold(dst, 5, 255, cv2.THRESH_BINARY)
...
def back_subtract(bg,frame):
    ...
    return foreground.copy(), img_dilation
...
def main():
    ...
    while capture.isOpened():
        ...
        frame, _ = back_subtract(bg,frame)
